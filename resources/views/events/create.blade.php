	...
	<div class="box col-md-12">
		<div class="box-inner">
			<div class="box-header well">
				<h2><i class="fa fa-thumb-tack"></i> Events</h2>
			</div>
					...
					<div class="col-md-8">
						...
						<div class="form-group">
							<div class="col-md-5">
                        		...
                        		{{Form::text('dateEvents',null,array('id' => 'datepicker','placeholder' => 'Date...','class' => 'form-control','required' => '','readonly' => 'true','style' => 'cursor:pointer; cursor:hand;'))}}
                        		<br>
